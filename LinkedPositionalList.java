...
public class LinkedPositionalList<E> implements PositionalList<E> {
	...
	private class PositionIterator implements Iterator<Position<E>> {
		...
		public Position<E> getpos() throws NoSuchElementException {
			if (cursor == null)
	...
	private class ElementIterator implements Iterator<E> {
		...
		/*
		public Position<E> getP()
		{
			return posIterator.getpos();
		}
		*/
		public void remove() {
			posIterator.remove();
	...
	public String toString() {
		...
		Node<E> walk = header.getNext();
		while (walk != trailer) {
			toString += (walk.getElement().toString());
			walk = walk.getNext();
			if (walk != trailer)
				toString += (", ");
		}
